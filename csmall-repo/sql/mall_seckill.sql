CREATE DATABASE `mall_seckill` DEFAULT CHARACTER SET utf8mb4;
USE `mall_seckill`;
...
insert into `seckill_sku`(`id`, `sku_id`, `spu_id`, `seckill_stock`, `seckill_price`, `gmt_create`, `gmt_modified`,
                          `seckill_limit`)
values (1, 1, 2, 0, 1000, '2022-02-22 16:43:09', '2022-02-28 16:17:44', 1),
...
insert into `seckill_spu`(`id`, `spu_id`, `list_price`, `start_time`, `end_time`, `gmt_create`, `gmt_modified`)
values (1, 2, 2000, '2022-02-23 16:51:40', '2022-03-01 16:51:42', '2022-02-23 16:51:45', '2022-02-23 16:51:48');
...
(
  ...
  AUTO_INCREMENT = 4
  DEFAULT CHARSET = utf8mb4 COMMENT ='秒杀成功表格';

/*Data for the table `success` */

insert into `success`(`id`, `seckill_id`, `user_id`, `user_phone`, `sku_id`, `title`, `main_picture`, `seckill_price`,
                      `quantity`, `gmt_create`, `gmt_modified`, `bar_code`, `data`, `order_sn`)
values (2, NULL, 1, NULL, 1, '2021年新款，小米11 Ultra黑色512G，16G超大内存120Hz高刷67w快充', 'picture1', 6999.99, 10,
        '2022-02-28 16:17:44', '2022-02-28 16:17:44', '0',
        '{\"attributes\":[{\"id\":1,\"name\":\"屏幕尺寸\",\"value\":\"6.1寸\"},{\"id\":3,\"name\":\"颜色\",\"value\":\"黑色\"},{\"id\":5,\"name\":\"运行内存\",\"value\":\"16GB\"}]}',
        NULL),
       (3, NULL, 1, NULL, 2, '2021年新款，小米11 Ultra黑色512G，16G超大内存120Hz高刷67w快充', 'picture1', 6999.99, 1,
        '2022-02-28 16:28:42', '2022-02-28 16:28:42', '0',
        '{\"attributes\":[{\"id\":1,\"name\":\"屏幕尺寸\",\"value\":\"6.1寸\"},{\"id\":3,\"name\":\"颜色\",\"value\":\"黑色\"},{\"id\":5,\"name\":\"运行内存\",\"value\":\"16GB\"}]}',
        NULL);
