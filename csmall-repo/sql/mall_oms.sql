...
(
  ...
  AUTO_INCREMENT = 3
  DEFAULT CHARSET = utf8mb4 COMMENT ='购物车数据表';
...
(
  ...
  AUTO_INCREMENT = 5012
  DEFAULT CHARSET = utf8mb4 COMMENT ='订单数据表';

/*Data for the table `oms_order` */

insert into `oms_order`(`id`, `sn`, `user_id`, `contact_name`, `mobile_phone`, `telephone`, `province_code`,
                        ...
                        `amount_of_original_price`, `amount_of_freight`, `amount_of_discount`, `amount_of_actual_pay`,
                        `gmt_order`, `gmt_pay`, `gmt_create`, `gmt_modified`)
values (5011, '01bb082e-88d3-4571-a3b5-f5fb01fdb2eb', 1, '刘先生', '13800138001', '010-88888888', '110000', '北京市',
        '110100', '市辖区', '110103', '海淀区', '00005', '中关村街道', '中关村软件园28-3-405', '公司', 1, 0, 100, 5000.00, 100.00, 0.00,
        0.00, NULL, NULL, '2022-03-16 11:42:11', '2022-03-16 11:42:11');
...
(
  ...
  AUTO_INCREMENT = 5011
  DEFAULT CHARSET = utf8mb4 COMMENT ='订单商品数据表';

/*Data for the table `oms_order_item` */

insert into `oms_order_item`(`id`, `order_id`, `sku_id`, `title`, `bar_code`, `data`, `main_picture`, `price`,
                             `quantity`, `gmt_create`, `gmt_modified`)
values (5006, 5007, 1, '2021年新款，小米11 Ultra黑色512G，16G超大内存120Hz高刷67w快充', '0',
        '[{\"id\":1,\"name\":\"屏幕尺寸\",\"value\":\"6.1寸\"},{\"id\":3,\"name\":\"颜色\",\"value\":\"黑色\"},{\"id\":5,\"name\":\"运行内存\",\"value\":\"16GB\"}]',
        'picture1', 6999.99, 10, NULL, NULL),
       (5007, 5008, 1, '2021年新款，小米11 Ultra黑色512G，16G超大内存120Hz高刷67w快充', '0',
        '[{\"id\":1,\"name\":\"屏幕尺寸\",\"value\":\"6.1寸\"},{\"id\":3,\"name\":\"颜色\",\"value\":\"黑色\"},{\"id\":5,\"name\":\"运行内存\",\"value\":\"16GB\"}]',
        'picture1', 6999.99, 10, NULL, NULL),
       (5008, 5009, 1, '2021年新款，小米11 Ultra黑色512G，16G超大内存120Hz高刷67w快充', '0',
        '[{\"id\":1,\"name\":\"屏幕尺寸\",\"value\":\"6.1寸\"},{\"id\":3,\"name\":\"颜色\",\"value\":\"黑色\"},{\"id\":5,\"name\":\"运行内存\",\"value\":\"16GB\"}]',
        'picture1', 6999.99, 10, NULL, NULL),
       (5009, 5010, 1, '2021年新款，小米11 Ultra黑色512G，16G超大内存120Hz高刷67w快充', '0',
        '[{\"id\":1,\"name\":\"屏幕尺寸\",\"value\":\"6.1寸\"},{\"id\":3,\"name\":\"颜色\",\"value\":\"黑色\"},{\"id\":5,\"name\":\"运行内存\",\"value\":\"16GB\"}]',
        'picture1', 6999.99, 10, NULL, NULL),
       (5010, 5011, 1, '2021年新款，小米11 Ultra黑色512G，16G超大内存120Hz高刷67w快充', '0',
        '[{\"id\":1,\"name\":\"屏幕尺寸\",\"value\":\"6.1寸\"},{\"id\":3,\"name\":\"颜色\",\"value\":\"黑色\"},{\"id\":5,\"name\":\"运行内存\",\"value\":\"16GB\"}]',
        'picture1', 6999.99, 10, '2022-03-16 11:42:11', '2022-03-16 11:42:11');
