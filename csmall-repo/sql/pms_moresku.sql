...
/*!40000 ALTER TABLE `pms_album`
    DISABLE KEYS */;
INSERT INTO `pms_album` (`id`, `name`, `description`, `sort`, `gmt_create`, `gmt_modified`)
VALUES (1, 'iPhone 13', NULL, 0, NULL, NULL),
...
/*!40000 ALTER TABLE `pms_attribute`
    DISABLE KEYS */;
INSERT INTO `pms_attribute` (`id`, `template_id`, `name`, `description`, `type`, `input_type`, `value_list`, `unit`,
                             `sort`, `is_allow_customize`, `gmt_create`, `gmt_modified`)
VALUES (1, 1, '屏幕尺寸', '智能手机屏幕尺寸', 0, 1, '6.1寸,6.3寸', '英寸', 0, 1, NULL, NULL),
...
/*!40000 ALTER TABLE `pms_attribute_template`
    DISABLE KEYS */;
INSERT INTO `pms_attribute_template` (`id`, `name`, `pinyin`, `keywords`, `sort`, `gmt_create`, `gmt_modified`)
VALUES (1, '智能手机', 'zhinengshouji', '手机', 0, NULL, NULL),
...
/*!40000 ALTER TABLE `pms_brand`
    DISABLE KEYS */;
INSERT INTO `pms_brand` (`id`, `name`, `pinyin`, `logo`, `description`, `keywords`, `sort`, `sales`, `product_count`,
                         `comment_count`, `positive_comment_count`, `enable`, `gmt_create`, `gmt_modified`)
VALUES (1, '华为', 'huawei', NULL, '华为专注网络设备三十年', '华为,huawei,mate,magicbook', 0, 0, 0, 0, 0, 1, NULL, NULL),
...
/*!40000 ALTER TABLE `pms_brand_category`
    DISABLE KEYS */;
INSERT INTO `pms_brand_category` (`id`, `brand_id`, `category_id`, `gmt_create`, `gmt_modified`)
...
/*!40000 ALTER TABLE `pms_category`
    DISABLE KEYS */;
INSERT INTO `pms_category` (`id`, `name`, `parent_id`, `depth`, `keywords`, `sort`, `icon`, `enable`, `is_parent`,
                            `is_display`, `gmt_create`, `gmt_modified`)
VALUES (1, '手机 / 运营商 / 数码', 0, 1, NULL, 0, NULL, 1, 1, 1, NULL, NULL),
...
/*!40000 ALTER TABLE `pms_category_attribute_template`
    DISABLE KEYS */;
INSERT INTO `pms_category_attribute_template` (`id`, `category_id`, `attribute_template_id`, `gmt_create`,
                                               `gmt_modified`)
VALUES (1, 3, 1, '2022-03-31 11:52:13', '2022-03-31 11:52:15'),
...
/*!40000 ALTER TABLE `pms_picture`
    DISABLE KEYS */;
INSERT INTO `pms_picture` (`id`, `album_id`, `url`, `description`, `width`, `height`, `is_cover`, `sort`, `gmt_create`,
                           `gmt_modified`)
VALUES (1, 1, 'http://localhost:9060/iphone13.PNG', NULL, 1024, 768, 0, 0, NULL, NULL),
...
/*!40000 ALTER TABLE `pms_sku`
    DISABLE KEYS */;
INSERT INTO `pms_sku` (`id`, `spu_id`, `title`, `bar_code`, `attribute_template_id`, `specifications`, `album_id`,
                       `pictures`, `price`, `stock`, `stock_threshold`, `sales`, `comment_count`,
                       `positive_comment_count`, `sort`, `gmt_create`, `gmt_modified`)
VALUES (1, 2, '2021年新款，小米11 Ultra黑色512G，16G超大内存120Hz高刷67w快充', NULL, 1,
        '{"attributes":[{"id":1,"name":"屏幕尺寸","value":"6.1寸"},{"id":3,"name":"颜色","value":"黑色"},{"id":5,"name":"运行内存","value":"16GB"}]}',
        NULL, 'http://localhost:9060/1.PNG', 6999.99, 887, 50, 0, 0, 0, 0, NULL, '2022-05-08 18:15:05'),
       (2, 2, '2021年新款，小米11 Ultra白色512G，8G超大内存120Hz高刷67w快充', NULL, 1,
        '{"attributes":[{"id":1,"name":"屏幕尺寸","value":"6.1寸"},{"id":3,"name":"颜色","value":"白色"},{"id":5,"name":"运行内存","value":"8GB"}]}',
        NULL, 'http://localhost:9060/1.PNG', 6499.99, 745, 50, 0, 0, 0, 0, NULL, '2022-05-08 18:18:13'),
       (3, 1, '苹果手机iPhone 13白色 8G 6.1寸', NULL, 1,
        '{"attributes":[{"id":1,"name":"屏幕尺寸","value":"6.1寸"},{"id":3,"name":"颜色","value":"白色"},{"id":5,"name":"运行内存","value":"8GB"}]}',
        NULL, 'http://localhost:9060/0.PNG', 6200.00, 667, 50, 0, 0, 0, 0, NULL, '2022-05-08 18:18:13'),
       (4, 1, '苹果手机iPhone 13金色 16G 6.1寸', NULL, 1,
        '{"attributes":[{"id":1,"name":"屏幕尺寸","value":"6.1寸"},{"id":3,"name":"颜色","value":"金色"},{"id":5,"name":"运行内存","value":"16GB"}]}',
        NULL, 'http://localhost:9060/0.PNG', 7200.00, 416, 50, 0, 0, 0, 0, NULL, '2022-05-08 18:18:13'),
       (5, 3, '华为P50pro黑色 16G 6.3寸', NULL, 1,
        '{"attributes":[{"id":1,"name":"屏幕尺寸","value":"6.3寸"},{"id":3,"name":"颜色","value":"黑色"},{"id":5,"name":"运行内存","value":"16GB"}]}',
        NULL, 'http://localhost:9060/2.PNG', 6300.00, 771, 50, 0, 0, 0, 0, NULL, '2022-05-08 18:18:13'),
       (6, 3, '华为P50pro白色 16G 6.3寸', NULL, 1,
        '{"attributes":[{"id":1,"name":"屏幕尺寸","value":"6.3寸"},{"id":3,"name":"颜色","value":"白色"},{"id":5,"name":"运行内存","value":"16GB"}]}',
        NULL, 'http://localhost:9060/2.PNG', 6300.00, 613, 50, 0, 0, 0, 0, NULL, '2022-05-08 18:18:13'),
       (7, 4, 'mac Book Air 14寸 M1 Mac OS', NULL, 2,
        '{"attributes":[{"id":2,"name":"屏幕尺寸","value":"14寸"},{"id":6,"name":"CPU型号","value":"m1"},{"id":10,"name":"操作系统","value":"Mac OS"}]}',
        NULL, 'http://localhost:9060/3.PNG', 7680.00, 679, 50, 0, 0, 0, 0, NULL, '2022-05-08 18:18:13'),
       (8, 5, '华为MateBook 14寸 i5 Windows 10', NULL, 2,
        '{"attributes":[{"id":2,"name":"屏幕尺寸","value":"14寸"},{"id":6,"name":"CPU型号","value":"i5"},{"id":10,"name":"操作系统","value":"Windows 10"}]}',
        NULL, 'http://localhost:9060/4.PNG', 5300.00, 801, 50, 0, 0, 0, 0, NULL, '2022-05-08 18:18:13'),
       (9, 5, '华为MateBook 14寸 i7 Windows 10', NULL, 2,
        '{"attributes":[{"id":2,"name":"屏幕尺寸","value":"14寸"},{"id":6,"name":"CPU型号","value":"i7"},{"id":10,"name":"操作系统","value":"Windows 10"}]}',
        NULL, 'http://localhost:9060/4.PNG', 5800.00, 777, 50, 0, 0, 0, 0, NULL, '2022-05-08 18:18:13');
/*!40000 ALTER TABLE `pms_sku`
    ENABLE KEYS */;
...
/*!40000 ALTER TABLE `pms_sku_specification`
    DISABLE KEYS */;
INSERT INTO `pms_sku_specification` (`id`, `sku_id`, `attribute_id`, `attribute_name`, `attribute_value`, `unit`,
                                     `sort`, `gmt_create`, `gmt_modified`)
VALUES (1, 1, 1, '屏幕尺寸', '6.1', '寸', 0, NULL, NULL),
...
INSERT INTO `pms_spu` (`id`, `name`, `type_number`, `title`, `description`, `list_price`, `stock`, `stock_threshold`,
                       ...
                       `check_user`, `gmt_check`, `gmt_create`, `gmt_modified`)
VALUES (1, 'iPhone 13', 'A2404', '苹果手机iPhone 13（A2404）', '2021年新款，全网首发', 5690.00, 5000, 20, '部', 3, '苹果', 3, '智能手机',
        NULL, NULL, 'http://localhost:9060/0.PNG,http://localhost:9060/1.PNG', 'ip13,iPhone13,苹果13', '20w快充,NFC,无线充电',
        0, 0, 0, 0, 0, 1, 0, 0, 1, NULL, NULL, '2022-03-31 11:16:33', '2022-03-31 15:22:33'),
       (2, '小米11 Ultra', 'M112021', '小米11 Ultra（M112021）', '2021年最新旗舰机', 5299.00, 8000, 20, '部', 2, '小米', 3, '智能手机',
        NULL, NULL, 'http://localhost:9060/1.PNG', 'mi11,xiaomi11,ultra', '67w快充,1亿像素,5000毫安电池', 0, 0, 0, 0, 0, 1, 0, 0,
        1, NULL, NULL, '2022-03-31 11:16:37', '2022-03-31 15:22:36'),
       (3, '华为P50pro', 'P50pro', '华为P50pro', '2021年最新旗舰机', 5588.00, 8000, 20, '部', 1, '华为', 3, '智能手机', NULL, NULL,
        'http://localhost:9060/2.PNG', 'p50,p50pro', '...', 0, 0, 0, 0, 0, 1, 0, 0, 1, NULL, NULL,
        '2022-03-31 11:16:37', '2022-03-31 15:22:36'),
       (4, 'mac Book Air', 'mba', '苹果笔记本电脑', '轻薄笔记本', 7680.00, 8000, 20, '台', 3, '苹果', 8, '笔记本', NULL, NULL,
        'http://localhost:9060/3.PNG', 'macbook,air', '...', 0, 0, 0, 0, 0, 1, 0, 0, 1, NULL, NULL,
        '2022-03-31 11:16:37', '2022-03-31 15:22:36'),
       (5, '华为 MateBook', 'MateBook', '华为笔记本电脑', '强大功能的笔记本', 4680.00, 8000, 20, '台', 1, '华为', 8, '笔记本', NULL, NULL,
        'http://localhost:9060/4.PNG', 'huaweibook', '...', 0, 0, 0, 0, 0, 1, 0, 0, 1, NULL, NULL,
        '2022-03-31 11:16:37', '2022-03-31 15:22:36');
/*!40000 ALTER TABLE `pms_spu`
    ENABLE KEYS */;
...
/*!40000 ALTER TABLE `pms_spu_detail`
    DISABLE KEYS */;
INSERT INTO `pms_spu_detail` (`id`, `spu_id`, `detail`, `gmt_create`, `gmt_modified`)
VALUES (1, 1, '<div>iPhone 13的详情HTML</div>', NULL, NULL),
